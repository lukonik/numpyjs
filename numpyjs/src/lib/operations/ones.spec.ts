...
describe('ones', () => {
  ...
  describe('data types', () => {
    ...
    it('should work with BigInt64Array', () => {
      const arr = ones([3], DTypes.BigInt64Array);
      
      expect(arr.dtype).toBe(DTypes.BigInt64Array);
      expect(arr.buffer).toBeInstanceOf(BigInt64Array);
      expect(arr.at(0)).toBe(1n);
      expect(arr.at(1)).toBe(1n);
      expect(arr.at(2)).toBe(1n);
    });

    it('should work with BigUint64Array', () => {
      const arr = ones([3], DTypes.BigUint64Array);
      
      expect(arr.dtype).toBe(DTypes.BigUint64Array);
